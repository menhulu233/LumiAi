 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/LumiAi/main.log
 *   Windows: %USERPROFILE%\AppData\Roaming\LumiAi\logs\main.log
 *   Linux:   ~/.config/LumiAi/logs/main.log
 */
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`LumiAi started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
