...
This guide walks through testing the entire Web Search Skill integration with LumiAi.

## Prerequisites

1. LumiAi built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with LumiAi.

**Steps:**

1. Start LumiAi in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of LumiAi launch.
...
1. Open a terminal while LumiAi is running
...
**Objective:** Verify graceful shutdown of services when LumiAi quits.

**Steps:**

1. With LumiAi running and searches completed, quit the application
...
1. Start LumiAi (ensure headless is false in config)
...
- ✅ Server auto-starts with LumiAi
