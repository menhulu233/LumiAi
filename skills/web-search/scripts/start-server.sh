...
ensure_npm_available() {
  ...
  echo "  Please reinstall the web-search skill runtime from LumiAi."
  return 1
}
...
if ! resolve_node_runtime; then
  ...
  echo "  Please install Node.js, or run from LumiAi so scripts can use Electron runtime."
  exit 1
fi
